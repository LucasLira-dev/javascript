...
ALTER TABLE `tipousuario` ADD FOREIGN KEY (`n_tipousuario_tipousuario`) REFERENCES `usuario` (`n_tipousuario_tipousuario`);

ALTER TABLE `telefone` ADD FOREIGN KEY (`n_usuario_usuario`) REFERENCES `usuario` (`n_usuario_usuario`);

ALTER TABLE `telefone` ADD FOREIGN KEY (`n_usuario_usuario`) REFERENCES `telefone` (`n_telefone_telefone`);
